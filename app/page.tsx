...
export default function Home() {
  return (
    <div className="font-sans text-white bg-black overflow-x-hidden">
      ...
      >
        <div className="absolute top-0 left-1/4 w-72 h-72 bg-emerald-500/20 blur-2xl rounded-full pointer-events-none"></div>
        <div className="absolute bottom-10 right-1/4 w-64 h-64 bg-emerald-400/20 blur-2xl rounded-full pointer-events-none"></div>
      ...
      <section id="services" className="py-16 px-4 md:px-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={i}
              className="relative p-5 rounded-2xl bg-zinc-900/50 text-center border border-zinc-800 
             transition-all duration-300 hover:-translate-y-2 hover:border-emerald-500/50 hover:bg-zinc-800/70"
            >
      ...
      <section id="why-choose-us" className="py-16 px-4 md:px-10 max-w-6xl mx-auto mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          {[
            ...
            <div
              key={i}
              className="flex flex-col items-center gap-3 p-5 rounded-2xl bg-zinc-900/50 
                   text-center border border-zinc-800 transition-all duration-300 
                   hover:-translate-y-2 hover:border-emerald-500/50 hover:bg-zinc-800/70"
            >
